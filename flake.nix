    ...
    flake-utils.lib.eachDefaultSystem (
      ...
      let
        ...
        rust-nightly = fenix-pkgs.combine [
          ...
          fenix-pkgs.targets.x86_64-unknown-linux-musl.latest.rust-std
        ];
        ...
        msrv = (builtins.fromTOML (builtins.readFile ./super_orchestrator/Cargo.toml)).package.rust-version;
        rust-msrv =
